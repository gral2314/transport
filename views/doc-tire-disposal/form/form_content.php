            ...
            <form id="doc-tire-form-shell">
                ...
                <div class="tab-content border border-top-0 p-3 bg-white">
                    ...
                    <div class="tab-pane fade <?= empty($config['vehicleFields']) ? 'show active' : '' ?>" id="doc-tab-details">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h6 class="mb-0">Llantas a dar de baja</h6>
                            <button type="button" class="btn btn-outline-success btn-sm" id="add-detail-row"><i class="fa-solid fa-plus"></i> Agregar llanta</button>
                        </div>
                        <div class="table-responsive">
