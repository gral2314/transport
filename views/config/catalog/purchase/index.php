...
$this->title = 'Configuración SAP - Intercompany';
...
/*
echo \app\components\widgets\SidebarWidget::widget([
    'items' => [
        [
            'type' => 'caption',
            'label' => 'Navigation',
        ...
        [
            ...
            'icon' => 'ph ph-car',
            'items' => [
                ['label' => 'Tipos', 'url' => '/vehiculos/tipos'],
                ['label' => 'Combustibles', 'url' => '/vehiculos/combustibles'],
            ]
        ],
    ]
]);*/
...
echo \app\components\widgets\TabsWidget::widget([
    ...
    'items' => [
        ['label' => 'Finanzas','id' => 'pills-Finanzas','content' => '<p>Contenido Finanzas</p>',],
        ['label' => 'Ventas','id' => 'pills-Ventas','content' => '<p>Contenido Ventas</p>',],
        ['label' => 'Compras','id' => 'pills-Compras','content' => '<p>Contenido Compras</p>',],
        ['label' => 'Inventario','id' => 'pills-Inventario','content' => '<p>Contenido Inventario</p>',],
        ['label' => 'Vehiculos','id' => 'pills-Vehiculos','content' => $dbTable,'active' => true,],
        ['label' => 'Llantas','id' => 'pills-Llantas','content' => '<p>Contenido Llantas</p>',],
        ['label' => 'Mantenimiento','id' => 'pills-Mantenimiento','content' => '<p>Contenido Mantenimiento</p>',],
        ['label' => 'General','id' => 'pills-General','content' => '<p>Contenido General</p>',],
    ],
]);
