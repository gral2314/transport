...
class VehicleBrandServices
{
    ...
    {
        $model = VehicleBrand::findOne(['code' => $pk]);
        if ($model === null) {
    ...
    public function save(array $data, ?Transaction $transaction = null): array
    {
        ...
        try {
            $pk = $data['code'] ?? null;
            $model = ($pk !== null) ? VehicleBrand::findOne(['code' => $pk]) : null;
            if ($model === null) {
    ...
    public function getFormOptions(): array
    {
        return ['Success' => 'Ok', 'Msg' => '', 'Data' => [
            'active_options' => VehicleBrand::getActiveOptions(),
        ]];
    }
}
