...
class SnController extends Controller
{
    ...
    public function actionList(): \yii\web\Response
    {
        ...
        try { return $this->asJson((new BpServices())->list(Yii::$app->request->queryParams)); }
    ...
    {
        Yii::$app->response->format = \yii\web\Response::FORMAT_JSON;
        try { return $this->asJson((new BpServices())->get($pk)); }
        catch (\Throwable $e) { return $this->asJson(['Success' => 'Error', 'Msg' => $e->getMessage(), 'Data' => []]); }
    }
    ...
    public function actionSave(): \yii\web\Response
    {
        ...
        if (!empty($data['cardcode'])) {
            $isNew = !(\app\models\tables\Bp::find()->where(['cardcode' => $data['cardcode']])->exists());
        }
        try { return $this->asJson((new BpServices())->save($data)); }
        catch (\Throwable $e) { return $this->asJson(['Success' => 'Error', 'Msg' => $e->getMessage(), 'Data' => []]); }
    }
    ...
    {
        Yii::$app->response->format = \yii\web\Response::FORMAT_JSON;
        try { return $this->asJson((new BpServices())->getFormOptions()); }
        catch (\Throwable $e) { return $this->asJson(['Success' => 'Error', 'Msg' => $e->getMessage(), 'Data' => []]); }
    }
}
