...
use app\models\objects\DocumentTypeServices;
use Yii;
...
class DocumentTypeController extends Controller
{
    ...
    {
        $Services = new DocumentTypeServices();
    ...
    public function actionSave(): \yii\web\Response
    {
        ...
        $isNew = true;
        if (!empty($data['code'])) {
            $isNew = !(\app\models\tables\DocumentTypeCatalog::find()->where(['code' => $data['code']])->exists());
        }
        try {
            $Services = new DocumentTypeServices();
