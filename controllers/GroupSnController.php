...
use app\models\objects\GroupSnServices;
use Yii;
use yii\filters\AccessControl;
use yii\filters\VerbFilter;
use yii\web\Controller;

class GroupSnController extends Controller
{
    ...
    public function actionSave(): \yii\web\Response
    {
        ...
        $isNew = true;
        if (!empty($data['code'])) {
            $isNew = !(\app\models\tables\GroupSn::find()->where(['code' => $data['code']])->exists());
        }
