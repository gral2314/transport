...
use app\models\objects\EmployeeTypeServices;
use Yii;
...
class EmployeeTypeController extends Controller
{
    ...
    {
        $Services = new EmployeeTypeServices();
    ...
    public function actionSave(): \yii\web\Response
    {
        ...
        $isNew = true;
        if (!empty($data['code'])) {
            $isNew = !(\app\models\tables\EmployeeTypeCatalog::find()->where(['code' => $data['code']])->exists());
        }
        try {
            $Services = new EmployeeTypeServices();
