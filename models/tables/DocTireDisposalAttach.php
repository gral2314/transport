...
class DocTireDisposalAttach extends ActiveRecord
{
    public const INDEXES = [
        'ux_doc_tire_disposal_attach_docentry_linenum' => ['columns' => ['docentry', 'linenum'], 'unique' => true],
        'idx_doc_tire_disposal_attach_docentry' => ['columns' => ['docentry'], 'unique' => false],
    ];

    public static function tableName(): string
    {
        return '{{%doc_tire_disposal_attach}}';
    }
    ...
    {
        return $this->hasOne(DocTireDisposalDetail::class, ['docentry' => 'docentry', 'linenum' => 'linenum']);
    }
