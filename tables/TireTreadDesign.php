...
/**
 * TireTreadDesign — ActiveRecord para {{%tire_tread_design}} (Diseño de Rodada)
 *
 ...
 * @property Tire[] $tires
 */
class TireTreadDesign extends ActiveRecord
{
    ...
    {
        return $this->hasMany(Tire::class, ['tread_design_code' => 'code']);
    }
}
