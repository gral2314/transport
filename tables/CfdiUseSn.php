...
/**
 * This is the model class for table "cfdi_use_sn".
 *
 * @property string $code Código único del uso de CFDI
 * @property string $name Nombre del uso de CFDI
 ...
 * @property Bp[] $bps
 */
class CfdiUseSn extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            'code' => 'Código único del uso de CFDI',
            'name' => 'Nombre del uso de CFDI',
    ...
    {
        return $this->hasMany(Bp::class, ['cfdi_use_code' => 'code']);
    }
