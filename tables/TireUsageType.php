...
/**
 * TireUsageType — ActiveRecord para {{%tire_usage_type}} (Tipos de Uso de Llanta)
 *
 ...
 * @property Tire[] $tires
 */
class TireUsageType extends ActiveRecord
{
    public const ACTIVE_Y = 'Y';
    public const ACTIVE_N = 'N';

    // Códigos estándar de tipo de uso
    public const CODE_STR = 'STR'; // Dirección
    public const CODE_DRV = 'DRV'; // Tracción
    public const CODE_TRL = 'TRL'; // Remolque
    public const CODE_SPR = 'SPR'; // Refacción
    public const CODE_MIX = 'MIX'; // Mixto

    public static function tableName(): string
    {
        return '{{%tire_usage_type}}';
    }
    ...
    public function getTires(): \yii\db\ActiveQuery
    {
        return $this->hasMany(Tire::class, ['usage_type_code' => 'code']);
    }
}
